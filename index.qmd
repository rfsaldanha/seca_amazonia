...
Imagens da terra em cores reais, visíveis a olho nu.
...
Concentração de Material Particulado em Suspensão (MPS). Monóxido de Carbono (ppb) 40m - Total.

Fonte dos dados e mais opções: [INPE](http://meioambiente.cptec.inpe.br/index.php?lang=pt){target="_blank"}
:::

#### Column {width="50%"}

::: {.card title="Emissões de queimadas"}

![](){#inpe_b}\

Localização de focos de queimada e focos de calor.

Fonte dos dados e mais opções de visualização: [INPE](http://meioambiente.cptec.inpe.br/index.php?lang=pt){target="_blank"}
:::

# Imagem mais recente

::: {.card title="Satélite GOES"}
![](https://cdn.star.nesdis.noaa.gov/GOES16/ABI/SECTOR/nsa/GEOCOLOR/latest.jpg)\
...
::: {.card title="Previsão de emissão de monóxido de carbono"}
[Acesso o sistema Copernicus CAMS](https://atmosphere.copernicus.eu/charts/packages/cams/products/carbon-monoxide-forecasts?base_time=202408220000&layer_name=composition_co_totalcolumn&projection=classical_south_america){target="_blank"}\
:::

::: {.card title="Previsão de emissão de dióxido de carbono"}
[Acesso o sistema Copernicus CAMS](https://atmosphere.copernicus.eu/charts/packages/cams/products/carbon-dioxide-forecasts?base_time=202408220000&layer_name=composition_co2_totalcolumn&projection=classical_south_america){target="_blank"}\
:::

::: {.card title="Análise de atividades de incêndios"}
[Acesso o sistema Copernicus CAMS](https://atmosphere.copernicus.eu/charts/packages/cams/products/fire-activity){target="_blank"}\
:::
