...
::: {.card title="Previsão de dióxido de carbono"}
```{=html}
<iframe width="700" height="300" src="https://atmosphere.copernicus.eu/charts/embed/cams/carbon-dioxide-forecasts?layer_name=composition_co2_totalcolumn&player_dimension=valid_time&projection=classical_south_america" frameBorder="0" allowFullScreen></iframe> 
```

Previsão de dióxido de carbono na atmosfera para o hoje e próximos dias. Fonte: [Copernicus CAMS](https://atmosphere.copernicus.eu/charts/packages/cams/).
